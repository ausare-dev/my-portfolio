  ...
  return (
    <div className='mb-[4rem] md:mb-[8rem]'>
      ...
      <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit ut illum, commodi deserunt quas at quo nihil optio natus in sint assumenda consectetur tempora, dicta illo cumque ea ab quae.
      </p>
    </div>
  )
}
